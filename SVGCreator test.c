...
int main ( )
{
    ...
    circle( x, y, size, getRGBColor( red, green, blue ) ) ;
        ...
        for ( x = 69; x < 2999; x += y ) {
            green = rand ( ) % 255 ;
            red = rand( ) % 255 ;
            line ( x, x, y, y, "stroke:rgb(0,0,255);stroke-width:2") ;
            rect ( x, x, y, y, getRGBColor( red, green, blue ) ) ;
            circle( x, y, size, getRGBColor( red, green, blue ) ) ;
                ...
                for (y = 96 ; y < 1999; y+= x)
                {
                    ...
                    circle( x, y, size, getRGBColor( red, green, blue ) ) ;
                        ...
                        red = rand( ) % 255 ;
                        line ( x, x, y, y, "stroke:rgb(0,0,255);stroke-width:2") ;
                        rect ( x, x, x, 50, getRGBColor( red, green, blue ) ) ;
                        circle( x, y, size, getRGBColor( red, green, blue ) ) ;

                            for ( x = 37; x < 787; x +=37 ) {
							green = rand ( ) % 255 ;
							red = rand( ) % 255 ;
							line ( x, x, x, y, "stroke:rgb(0,0,255);stroke-width:2") ;
							rect ( x, y, x, y, getRGBColor( red, green, blue ) ) ;
							circle( x, y, size, getRGBColor( red, green, blue ) ) ;
